...
def run_migrations_online():
    # Считываем конфигурацию из alembic.ini
    config = context.config

    # Если файл конфигурации логирования существует, настраиваем логирование
    fileConfig(config.config_file_name)
    ...
    connectable = engine_from_config(
        ...
        url=SQLALCHEMY_DATABASE_URL  # Используем строку подключения к базе данных из вашего приложения
    )
